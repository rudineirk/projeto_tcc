...
Com a divisão da aplicação entre diversos processos, podem ocorrer falhas em
partes da aplicação que comprometam alguns serviços, mas que não impeçam o
...
funcionalidades mesmo que um serviço o qual este depende esteja com algum tipo
de problema.
