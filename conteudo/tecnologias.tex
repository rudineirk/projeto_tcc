...
de \ac{DDD}, e não é exclusiva de microsserviços.
Segundo \citeonline{Millet2015}, \ac{DDD} é um processo que alinha o
...
Ao executar o contêiner, as camadas da imagem são montadas no disco em modo
