...
a aplicação como um todo. Em de sistemas implementados com \ac{SOA}, os
...
de comunicação assincronos, como o \ac{HTTP}, os quais, por limitações físicas,
...
e não é exclusiva de microsserviços. Segundo \citeonline{Millet2015}, \ac{DDD}
...
estilo \ac{REST}, de pesquisa em sistemas de busca de websites. O recurso
...
\citeonline{Matthias2015}, máquinas virtuais e contêineres compartilham o
...
disponíveis no kernel Linux para rodar aplicações com segurança dentro de um
\emph{sandbox}. A criação de contêineres é feita por meio de imagens, as quais
são distribuídas em repositórios públicos, que disponibilizam imagens
...
Ao rodar o contêiner, as camadas da imagem são montadas no disco em modo
...
ser também em nível de processos. Segundo \citeonline{Matthias2015},
