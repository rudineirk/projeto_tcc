...
utilizados em \ac{MQs}, send o primeiro chamado \emph{request-reply}, onde
...
O último padrão de comunicação de \ac{MQs} é o \emph{publisher-subscriber},
...
\begin{figure}[H]
	...
	\includegraphics[width=1.0\textwidth]{figuras/mq-pubsub.png}
...
A figura \ref{fig:mq-coupling} mostra uma representação visual destes dois
...
Existem algumas vantagens na utilização de \ac{MQs} centralizadas, sendo uma
